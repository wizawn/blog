...
- ✅ **Clash 代理** - 已配置 3 个 vmess 节点（新加坡/印度/台湾），端口 7890
- ⏳ **抖音爬取** - 有反爬限制，需评估
- ❌ **ARL/Nuclei 扫描** - 已彻底放弃（2026-03-08），本地文件已清理，定时任务已删除
- ❌ **ClawGuard-BNB** - 已彻底放弃（2026-03-08），本地文件已清理

## 已放弃项目清单

### ClawGuard-BNB（2026-03-08 放弃）
- **原因**：项目方向调整，聚焦核心业务
- **清理内容**：
  - `binance-project/` 目录
  - `01_Projects/ClawGuard-BNB/` 源码
  - 币安博客文章及备份
  - API Skills 及相关配置
- **保留项**：nuclei 模板中的 binance 扫描器（通用安全工具）
